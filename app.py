...
if pestaña == "Inicio":
    ...
    with tabsVecindario[2]:
        calendar_data = pd.read_csv("https://www.dropbox.com/scl/fi/9qfg5rs5z1619t5fy86m2/calendar.csv?rlkey=4n6wyhdu72m3jcz9syisgyecv&st=bwh2936i&dl=0", low_memory=False)
